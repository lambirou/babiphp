...
class Paginator
{
    ...
    public function __construct($totalItems, $itemsPerPage, $currentPage, $urlPattern = '')
    {
        ...
        $this->itemsOffset = ($this->totalItems % $this->itemsPerPage);
    ...
    /**
     * Permet de sinder les données en portions 
     *
     * @param array $data
     * @return array
     */
    public function setDataRows(array $data)
    {
        if ($this->currentPage == 1) {
            ...
            $start = $index * $this->itemsPerPage;
        }
        
        return array_slice($data, $start, $this->itemsPerPage);
    }
