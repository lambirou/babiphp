 ...
 */
    ...
    use BabiPHP\Error\Exception\Formatter;
    use BabiPHP\Error\Util\Misc;
    use BabiPHP\Error\Util\TemplateHelper;
    use BabiPHP\Debug\Debugbar;
    ...
    class PrettyPageHandler extends Handler
    {
         ...
         * @var string
         */
        private $pageTitle = "BabiPHP Application Error";
        ...
        public function handle()
        {
            if (!$this->handleUnconditionally()) {
                ...
                if (php_sapi_name() === 'cli') {
                    ...
                    if (isset($_ENV['BabiPHP\Error-test'])) {
                        throw new \Exception(
                            'Use handleUnconditionally instead of BabiPHP\Error-test'
            ...
            $cssFile      = $this->getResource("css/style.base.css");
            $prettifyFile    = $this->getResource("js/prettify.js");
            $zeptoFile    = $this->getResource("js/zepto.min.js");
            $clipboard    = $this->getResource("js/clipboard.min.js");
            $jsFile       = $this->getResource("js/script.base.js");
            ...
            if ($this->applicationPaths) {
                /* @var \BabiPHP\Error\Exception\Frame $frame */
        ...
        */
        ...
        public function addDataTableCallback($label, /* callable */ $callback)
        {
            ...
            $this->extraTables[$label] = function (\BabiPHP\Error\Exception\Inspector $inspector = null) use ($callback) {
                try {
