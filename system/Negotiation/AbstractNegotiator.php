...
use BabiPHP\Negotiation\Exception\InvalidArgument;
use BabiPHP\Negotiation\Exception\InvalidHeader;
...
abstract class AbstractNegotiator
{
    ...
    public function getBest($header, array $priorities, $strict = false)
    {
        ...
        $specificMatches = array_reduce($matches, 'BabiPHP\Negotiation\Match::reduce', []);

        usort($specificMatches, 'BabiPHP\Negotiation\Match::compare');
