 ...
 * @package       system.BASEPATH.function
...
if (!function_exists('asset')) {
	...
	{
		return FUNC_BASE_URL . '/' . trim($asset, '/');
	}
}
...
if (!function_exists('url')) {
	...
	function url($url = null)
	{
		...
		$url = trim($url, '/');
		return ($url) ? FUNC_BASE_URL . '/' . $url : FUNC_BASE_URL;
	}
}
...
if (!function_exists('is_flash')) {
	/**
	 * Permet de vérifier si le message flash existe
	 *
	 * @return bool
	 */
	function is_flash()
	{
		return (Session::getInstance())->checkFlash();
	}
}
...
if (!function_exists('get_flash')) {
	...
	function get_flash()
	{
		return (Session::getInstance())->getFlash();
	}
}
